    ...
    function activate_columns(): void {
        ...
        foreach ($columns as [$dbname, $ename, $cname, $data_type, $default, $is_nullable, $comment, $length, $key, $type]) {
            ...
            if (isset($key) && $key == 'PRI') {
                ...
                //framework
                $column = new primary($dbname, $ename, $cname, $data_type, $default, $is_nullable, $comment, $length,$type);
            }
            //
            //Create an ordinary column. It will be upgrated to a foreinn key
            //at a later stage, if necessary.
            else {
                $column = new attribute($dbname, $ename, $cname, $data_type, $default, $is_nullable, $comment, $length,$type);
            }
            //
...
class primary extends capture {
    ...
    function __construct(
        ...
        //column name 
        parent::__construct($dbname, $ename, $name, $data_type, $default, $is_nullable, $comment, $length,$type);
    }
